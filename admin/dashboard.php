    ...
    <div class="completion-track">
      ...
      <p class="small text-muted mb-2 mt-1">
        ...
        <?php if ($missingFiles > 0): ?>
          <strong><?= $missingFiles ?> buku</strong> masih metadata saja, belum bisa dibaca siswa.
        <?php else: ?>
      ...
      <?php if ($missingFiles > 0): ?>
        <a href="<?= BASE_URL ?>/admin/books.php?missing_file=1" class="btn btn-sm btn-clay mt-2">
          <i class="bi bi-arrow-right"></i> Lengkapi <?= $missingFiles ?> Buku Sekarang
        </a>
      <?php endif; ?>
    </div>
  </div>
  ...
  <div class="col-md-3 col-6">
    <a href="<?= BASE_URL ?>/admin/book_form.php" class="quick-tile">
      <div class="admin-card admin-card-pad">
        ...
        <div class="small text-muted">Satu per satu, lengkap dengan PDF</div>
      </div>
    </a>
  </div>
  <div class="col-md-3 col-6">
    <a href="<?= BASE_URL ?>/admin/import_official.php" class="quick-tile">
      <div class="admin-card admin-card-pad">
        ...
        <div class="small text-muted">Data Kemendikdasmen — metadata saja</div>
      </div>
    </a>
  </div>
  <div class="col-md-3 col-6">
    <a href="<?= BASE_URL ?>/admin/import_google_books.php?tab=bulk" class="quick-tile">
      <div class="admin-card admin-card-pad">
        ...
        <div class="small text-muted">Google Books — metadata saja</div>
      </div>
    </a>
  </div>
  <div class="col-md-3 col-6">
    <a href="<?= BASE_URL ?>/admin/import_csv.php" class="quick-tile">
      <div class="admin-card admin-card-pad">
        ...
        <div class="small text-muted">Efisien, bisa sertakan link PDF</div>
      </div>
    </a>
  </div>
</div>
